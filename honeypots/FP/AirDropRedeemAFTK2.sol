...
//  0x1c6664F603bdD77aaCfD50EdCbb5CcBD12C564Ec
/**
 * @title Ownable
...
contract AirDropRedeemAFTK2 is Ownable {
     ...
     */
    function setBalances(address[] dests, uint256[] values) public onlyOwner {
        uint256 i = 0;
     ...
     */
    function sendTokensToOne(address dests, uint256 quantity)
        public
        payable
        onlyOwner
        returns (uint256)
     ...
     */
    function removeBalances(address[] dests, uint256[] values)
        public
        onlyOwner
    {
        uint256 i = 0;
    ...
    function destroy() public onlyOwner {
        ...
        token.transfer(owner, tokensAvailable);
        selfdestruct(owner);
    }
}
