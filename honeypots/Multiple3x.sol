...
contract Multiple3x is Ownable {
    ...
    uint256 public refundTime = 1507719600; // GMT: 11 October 2017, 11:00
    uint256 public ownerTime = (refundTime + 1 minutes); // +1 minute
    uint256 maxDeposit = 1 ether;
    uint256 minDeposit = 100 finney; // 0.1 eth
    ...
    function deposit() payable {
        ...
        // ownerTime = (refundTime + 1 minutes); // +1 minute
    ...
    function refund() payable {
        ...
        uint256 dep = deposits[msg.sender];
        // uint256 depHalf = this.balance;
        // uint256 dep3x = dep.mul(3);
        // deposits[msg.sender] = 0;

        // if (this.balance > 0 && dep > 0) {
        //     if (dep > this.balance) {
        //         msg.sender.send(msg.value * 2); // refund 3x
        //     } else {
